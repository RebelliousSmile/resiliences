...
## FIN-3 — L'Offre
##
## Conditions : confiance_confluence <4 · relation_lise ≥7
##              · LUMEN intégré (lumen_etat = ACTIF)
##
## TODO : contenu narratif, musique de fin, crédits.

const TIMELINE_PATH : String = "res://dialogic/fins/fin_offre.dtl"
...
func _demarrer_fin() -> void:
	...
	if dialogic == null or not ResourceLoader.exists(TIMELINE_PATH):
		push_warning("FinManager — L'Offre : timeline manquante %s" % TIMELINE_PATH)
		return
